...
var _user$project$Main$initialUrl = 'https://www.youtube.com/watch?v=3VHUpGxFJJ8';
var _user$project$Main$Model = F4(
	function (a, b, c, d) {
		return {url: a, downloading: b, audioUrl: c, errorMsg: d};
	});
...
var _user$project$Main$getAudio = function (url) {
	var task = A2(
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				['info', 'url']),
			_elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Basics_ops['++'], 'https://youtube-dl.appspot.com/api/info?format=bestaudio&url=', url));
	return A3(_elm_lang$core$Task$perform, _user$project$Main$FetchError, _user$project$Main$FetchSuccess, task);
};
			...
			case 'ConvertIt':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{downloading: true}),
					_1: _user$project$Main$getAudio(model.url)
				};
			case 'FetchError':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{errorMsg: 'oops', downloading: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{downloading: false, audioUrl: _p0._0}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$Main$ConvertIt = {ctor: 'ConvertIt'};
		...
		A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onInput(_user$project$Main$InputChanged),
							_elm_lang$html$Html_Attributes$placeholder(_user$project$Main$initialUrl),
							_elm_lang$html$Html_Attributes$style(
							_elm_lang$core$Native_List.fromArray(
								[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(_user$project$Main$ConvertIt)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$src(model.audioUrl),
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href(model.audioUrl),
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				model.downloading ? _elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Downloading')
					]) : (_elm_lang$core$Basics$not(
					_elm_lang$core$String$isEmpty(model.errorMsg)) ? _elm_lang$core$Native_List.fromArray(
					[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text('This is free software, source code on '),
										A2(
										_elm_lang$html$Html$a,
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Attributes$href('https://github.com/cbenz/youtube-dl-audio')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: {url: _user$project$Main$initialUrl, downloading: false, audioUrl: '', errorMsg: ''},
				_1: _elm_lang$core$Platform_Cmd$none
			},
